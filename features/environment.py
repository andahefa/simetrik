...
from lib.pages.accommodationspage import AccommodationsPage
...
from lib.pages.packagesPage import PackagesPage
...
def before_all(context):
    ...
    context.flights_page = FlightsPage(context)
    context.accommodations_page = AccommodationsPage(context)
    context.cars_page = CarsPage(context)
    context.packages_page = PackagesPage(context)

    contexts = {
        'home': context.home,
        'flights': context.flights_page,
        'accommodations': context.accommodations_page,
        'cars': context.cars_page,
        'packages': context.packages_page,
    }
